...
import static financasgenericas.controler.ControlerDespesa.getAReceberUsuarioLogado;
import static financasgenericas.controler.ControlerDespesa.getDividaUsuarioLogado;
...
public class TelaPrincipal extends TelaLogado {
    ...
    private void construirTela() {
        ...
        lblValorDivida = new JLabel(String.format("R$ %.2f", getDividaUsuarioLogado()));

        lblValorAReceber = new JLabel(String.format("R$ %.2f",getAReceberUsuarioLogado()));
        atualizarDespesas();
